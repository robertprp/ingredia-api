...
exports.updateUserPreferencesSchema = zod_1.z
    ...
    locale: zod_1.z.string().trim().regex(/^[a-z]{2}-[A-Z]{2}$/).optional(),
})
    .refine((value) => Object.keys(value).length > 0, 'At least one field is required');
exports.createComparisonSchema = zod_1.z.object({
    analysisIds: zod_1.z.tuple([zod_1.z.string().uuid(), zod_1.z.string().uuid()]).refine(([left, right]) => left !== right, 'Analyses must be different'),
});
...
exports.verifyMobilePurchaseSchema = zod_1.z.object({
    provider: zod_1.z.enum([SubscriptionProvider.APPLE, SubscriptionProvider.GOOGLE_PLAY]),
...
exports.createSourceSchema = zod_1.z.object({
    key: zod_1.z.string().trim().regex(/^[a-z0-9.-]+$/).max(100),
